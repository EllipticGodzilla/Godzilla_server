...
abstract class ClientsList {
    ...
    public static JPanel init() {
        ...
        String[] reg_client = Net_listener.registered_account();
        for (String client : reg_client) {
            add(client, OFFLINE);
        }
    ...
    public static void add(String name, int type) { //aggiunge una nuova casella nell'ultima posizione
    ...
    public static boolean move(String cell_txt, int new_type, String new_txt) {
    ...
    private static class ListCell_popup extends JPopupMenu { //popup menu delle celle di questa lista
        ...
        private String[] unpair_clients() throws InvalidAlgorithmParameterException, IllegalBlockSizeException, IOException, BadPaddingException, InvalidKeyException { //divide i due client
